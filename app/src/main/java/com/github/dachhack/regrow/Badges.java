...
import com.github.dachhack.regrow.actors.mobs.Acidic;
import com.github.dachhack.regrow.actors.mobs.Albino;
import com.github.dachhack.regrow.actors.mobs.Bandit;
import com.github.dachhack.regrow.actors.mobs.Mob;
import com.github.dachhack.regrow.actors.mobs.Senior;
import com.github.dachhack.regrow.actors.mobs.Shielded;
...
public class Badges {
	...
	public static enum Badge {
		MONSTERS_SLAIN_1("10 enemies slain", 0), MONSTERS_SLAIN_2(
				...
				"Death from falling down", 59), YASD(
				"Death from fire, poison, toxic gas & hunger", 34, true), BOSS_SLAIN_1_WARRIOR, BOSS_SLAIN_1_MAGE, BOSS_SLAIN_1_ROGUE, BOSS_SLAIN_1_HUNTRESS, BOSS_SLAIN_1(
				...
				"3rd boss slain by Gladiator, Berserker, Warlock, Battlemage, "
						+ "Freerunner, Assassin, Sniper & Warden", 33, true), RING_OF_HAGGLER(
				"Ring of Haggler obtained", 20), RING_OF_THORNS(
				"Ring of Thorns obtained", 21), STRENGTH_ATTAINED_1(
